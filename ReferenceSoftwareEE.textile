...
Check "Openstack-Liberty":https://github.com/96boards/documentation/wiki/Openstack-Liberty for instructions on how to install and run OpenStack Liberty on Debian Jessie.
