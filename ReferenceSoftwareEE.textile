...
The Reference Platform kernel will act as an integration point for various features and platform-enablement code under review upstream on the latest kernel. It is not meant to be a stable kernel - the LSK is already available for that. This will allows validation of features against several distribution variants e.g. Debian, CentOS (and eventually AOSP)
