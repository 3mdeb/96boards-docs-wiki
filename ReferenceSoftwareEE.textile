...
The Reference Platform kernel will act as an integration point (very similar to linux-next) for various upstream-targeted features and platform-enablement code on the latest kernel. It is not meant to be a stable kernel - the "LSK":https://wiki.linaro.org/LSK is already available for that.
