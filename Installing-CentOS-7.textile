...
*Note:* @inst.ks@ is required for the reference platform entry because of the additional repository (that contains the kernel rpm package), which is available inside the @initrd.img@, including just @repo --name="rsalveti" --baseurl=http://repo.linaro.org/rpm/rsalveti/centos-7/repo/@.
...
repo --name="rsalveti" --baseurl=http://repo.linaro.org/rpm/rsalveti/centos-7/repo/
lang en_US.UTF-8
keyboard us
