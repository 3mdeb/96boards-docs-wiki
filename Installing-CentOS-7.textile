...
This guide is also heavily based on the instructions for "Fedora 23":https://github.com/96boards/documentation/wiki/Installing-Fedora-23 used for Fedora 23.
