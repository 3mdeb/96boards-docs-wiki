...
h4. Downloading the CentOS installer that includes the Reference Kernel (4.4.0, supporting additional hardware platforms), based on the Reference Platform 16.03 release:
...
bc. menuentry 'Install CentOS 7 ARM 64-bit - Reference Platform - 16.03' --class red --class gnu-linux --class gnu --class os {
