...
menuentry 'Install CentOS 7 ARM 64-bit - RP (experimental)' --class red --class gnu-linux --class gnu --class os {
    linux (tftp)/centos7/vmlinuz ip=dhcp inst.stage2=https://builds.96boards.org/snapshots/reference-platform/components/centos-installer/latest/ inst.repo=http://mirror.centos.org/altarch/7/os/aarch64/
    initrd (tftp)/centos7/initrd.img
}
