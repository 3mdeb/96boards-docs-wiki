h2. Installing Debian "Jessie" 8.3
...
h4. Downloading debian-installer:*
...
bc. d-i preseed/late_command string in-target apt-get install -y linux-image-reference-arm64; # here you can add 'in-target foobar' for additional commands
...
bc. sudo apt-get build-dep debian-installer
...
bc. fakeroot make build_netboot
