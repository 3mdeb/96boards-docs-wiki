...
Our custom installer changes nothing more than the kernel, and you can also find the instructions to build it from source at *TODO*
...
d-i netcfg/hostname string overdrive
...
d-i passwd/root-password-crypted password WIFHpCZovQdhU
d-i passwd/user-fullname string Linaro
d-i passwd/username string linaro
d-i passwd/user-password-crypted password WIFHpCZovQdhU
