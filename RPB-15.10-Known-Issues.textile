...
* Freedreno graphics driver not yet available by default (packages not yet included in linaro-overlay)
* "Bug 43":https://bugs.96boards.org/show_bug.cgi?id=43 - Iceweasel browser exits after file download complete
* "Bug 157":https://bugs.96boards.org/show_bug.cgi?id=157 - HDMI Audio not working
...
* "Bug 154":https://bugs.96boards.org/show_bug.cgi?id=154 - glxgears and tuxracer benchmarks failed to run
