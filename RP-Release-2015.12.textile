...
Documentation covering build from source, firmware flashing and network installers (including automation with preseed) available at "https://github.com/96boards/documentation/wiki/ReferenceSoftwareEE":https://github.com/96boards/documentation/wiki/ReferenceSoftwareEE
